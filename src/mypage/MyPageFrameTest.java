...
public class MyPageFrameTest extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					MyPageFrameTest frame = new MyPageFrameTest();
...
//		lblMember.setFont(new Font("±¼¸²", Font.PLAIN, 35));
		...
		lblTicketInfo.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				TicketInfoFrameTest tkInfo = new TicketInfoFrameTest();
