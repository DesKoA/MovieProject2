...
import db.dao.ReserveDBMgrTest;
...
public class TicketInfoFrameTest extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					TicketInfoFrameTest frame = new TicketInfoFrameTest();
	...
	public TicketInfoFrameTest() {
		...
		ReserveDBMgrTest rvMgr = new ReserveDBMgrTest();
